class DinamicosVista
{		
	constructor(ventana)
	{	
		this.ventana = ventana;
		this.presentador = new DinamicosPresentador(this);
	...
	cargargridCriterio()
	{		
			// este el grid 3  /// ahora es grid 2 
			this.grid3._columnas = [
				
				{longitud:200, 	titulo:"lola", 	alias:"campoId", alineacion:"I" },
				{longitud:200, 	titulo:"lola", 	alias:"tituloCampo", alineacion:"I" },
				{longitud:200, 	titulo:"lola", 	alias:"ordenCampo", alineacion:"I" },
				{longitud:200, 	titulo:"lola", 	alias:"presentacionCampo", alineacion:"I" },
				{longitud:200, 	titulo:"lola", 	alias:"tablaId", alineacion:"I" },
				{longitud:200, 	titulo:"lola", 	alias:"versionId", alineacion:"I" }
	...
	*/
		btnAlta_onClick()
	{
		...
		btncriterios_onClick()
		{
	        ...
	        this.presentador.consultarPorCampo();
		    this.presentador.consultarPorDinamico();
	...
	get criteriosDinamico ()
	{
		 var criteriosDinamico = 
		 {				    
			id:this.grid._selectedItem.id
		 }
		 return criteriosDinamico;		 
	}	
...
var vista = new DinamicosVista(this);
