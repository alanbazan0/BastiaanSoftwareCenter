class PortablesPresentador
{
	 ...
	 {
		 var repositorio = new PortablesRepositorio(this);			 
		 repositorio.insertar(this,this.insertarResultado,this.vista.portable);	
	 }
	 ...
	 {
		 var repositorio = new PortablesRepositorio(this);		
		 repositorio.actualizar(this,this.actualizarResultado,this.vista.portable);
	 }
	 ...
	 {		
		 if(resultado.mensajeError=="")
		 {
			 this.vista.portable = resultado.valor;
		 }
		 else
