								 ...
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								    	...
								    	<td >
								   		...
								   		<td >
								     		<label style="position: relative; left: 3px; ">Version descripciÃ³n Larga</label>
								   		</td>
								  		
								   		<td >
								     		<input class="input" id="descripcionLargaFormularioInput" descripcion="Descripciòn larga" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   </tr>
								   <tr>
