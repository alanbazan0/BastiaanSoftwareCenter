						...
						<div id="botones" style="width:auto;overflow:auto;">
							<table class="tablaBotonesIEC">
								<tr>
									...
									<td><img id="btnConsulta" class="botonMenuIEC" title="Cansulta" src="assets/botones/imgCambio.png" onClick="vista.btnConsulta_onClick();"></td>
								   ...
								   <tr>
								    ...
								    <tr>
    								    ...
    								    <td>
    								     ...
    								     <td>
    								    	<input class="input" id="correoElectronicoFormularioInput" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px"/>
    								    </td>
								    </tr>
								   </table>
