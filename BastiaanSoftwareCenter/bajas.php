...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/repositorios/bajas_repositorio.js"></script>
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/bajas_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/bajas_vista.js"></script>
							...
							<table style="position:relative;left:40px; text-align:left; margin-top:10px; margin-bottom:10px;">
								<tr>
									...
									<td style="padding:6px 0px 4px 10px;">		<input  id='idCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>
			      					<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Motivo</label></td>
									<td style="padding:6px 0px 4px 10px;">		<input  id='motivoCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>				
								</tr>
...
<!--  barra de men� para botones de la pantalla
 -->
			<div id="menuPrincipal"  align="right" class="contieneCriteriosAribaBtn" style="background-color: #6b6b6b;    height: 56px; " > 
				...
				<span id="txtTitulo" style="float:left;margin-top: 20px;margin-left: 15px;color: #FFFFFF;float: left;font-family: Verdana;font-size: 11px;font-weight: bold;">Bajas</span>
					 		...
					 		<div class="explicacionFRM" >
								<div id="filtros " class="contenedorIEC" style="overflow: auto; position: relative; width: 100%; display: block;">
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								    	<td >
								     		 <label style=" width:130px; position: relative; left: 3px; ">Id Baja</label>
								   		</td>
								   		<td >
								    	...
								    	<td >
								     		<label style="position: relative; left: 3px; ">Motivo</label>
								   		</td>
								   		<td >
								     		<input class="input" id="motivoFormularioInput" descripcion="motivo" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		</table>	    
