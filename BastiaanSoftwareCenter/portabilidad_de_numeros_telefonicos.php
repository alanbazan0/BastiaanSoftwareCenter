...
?>
<html> 
<title>Catalogo de portabilidad de numeros telefonicos</title>
<head>	
...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/portables_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/portables_vista.js"></script>
			...
			<div id="contieneCriteriosAriba" class="contieneCriteriosAriba">
				<div id="contieneCriteriosAribaBtn" class="contieneCriteriosAribaBtn">
					<div id="PMenu" align="center">
						...
						<div id="titulo" style="margin-left:280px;" class="tituloIEC">Catalogo de portabilidad de numeros telefonicos</div>
					</div>
				</div>
            </div>        
	     </div>
					...
					<div id="criteriosSeleccion0_t2" style="float:left; margin-top: 6px; margin-left: 10px;">
						<div>
							<table style="position:relative;left:40px; text-align:left; margin-top:10px; margin-bottom:10px;">
								<tr>
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Id de municipio</label></td>									
									<td style="padding:6px 0px 4px 10px;">		<input  id='idMunicipioCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Id consecutivo</label></td>
									<td style="padding:6px 0px 4px 10px;">		<input  id='idConsecutivoCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>			
								</tr>
...
<!--  barra de men� para botones de la pantalla
 -->
			<div id="menuPrincipal"  align="right" class="contieneCriteriosAribaBtn" style="background-color: #6b6b6b;    height: 56px; " > 
				...
				<span id="txtTitulo" style="float:left;margin-top: 20px;margin-left: 15px;color: #FFFFFF;float: left;font-family: Verdana;font-size: 11px;font-weight: bold;">Catalogo de areas</span>
					 		...
					 		<div class="explicacionFRM" >
								<div id="filtros " class="contenedorIEC" style="overflow: auto; position: relative; width: 100%; display: block;">
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								   <td >
								     		 <label style=" width:130px; position: relative; left: 3px; ">Id de municipio</label>
								   		</td>
								   		<td >
								     		<input class="input" id="idMunicipioFormularioInput" type="text" maxlength="20" value="" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px;"/>
								   		</td>
								    	<td >
								     		 <label style=" width:130px; position: relative; left: 3px; ">Id consecutivo</label>
								   		</td>
								   		<td >
								     		<input class="input" id="idConsecutivoFormularioInput" type="text" maxlength="20" value="" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px;" disabled />
								   		</td>
								   		
								    </tr>
								   	 <tr>
								    	<td >
								     		<label style="position: relative; left: 3px; ">Numero de portabilidad</label>
								   		</td>
								   		<td >
								     		<input class="input" id="numeroPortabilidadFormularioInput" descripcion="Numero de portabilidad" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		<td>						    
								    		<label style="position: relative; left: 3px; ">Descripcion de la portabilidad</label>
								   		</td>
								   		<td>						    
								    		<input class="input" id="descripcionPortabilidadFormularioInput" descripcion="Descripcion de la portabilidad" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px"/>
								   		</td>
								   		<td >
								     		<label style="position: relative; left: 3px; ">Ciudad de la portabilidad</label>
								   		</td>
								   		<td >
								     		<input class="input" id="ciudadPortabilidadFormularioInput" descripcion="Nombre Area" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		<td>						    
								    		<label style="position: relative; left: 3px; ">Municipio de la portabilidad</label>
								   		</td>
								   		<td>						    
								    		<input class="input" id="municipioPortabilidadFormularioInput" descripcion="Municipio de la portabilidad" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px"/>
								   		</td>
								   		<td>						    
								    		<label style="position: relative; left: 3px; ">Estado de la portabilidad</label>
								   		</td>
								   		<td>						    
								    		<input class="input" id="estadoPortabilidadFormularioInput" descripcion="Estado de la portabilidad" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px"/>
								   		</td>
								    </tr>
								   </table>
