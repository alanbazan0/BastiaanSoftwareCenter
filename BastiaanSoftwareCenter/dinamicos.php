...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/repositorios/dinamicos_repositorio.js"></script>
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/dinamicos_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/dinamicos_vista.js"></script>
			...
			<div id="contieneCriteriosAriba" class="contieneCriteriosAriba">
				<div id="contieneCriteriosAribaBtn" class="contieneCriteriosAribaBtn">
					<div id="PMenu" align="center">
						...
						<div id="titulo" style="margin-left:280px;" class="tituloIEC">grid dinamicos</div>
					</div>
				</div>
            </div>        
	     </div>
