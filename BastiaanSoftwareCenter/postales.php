...
?>
<html> 
<title>Catalogo de Postales</title>
<head>	
...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/postales_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/postales_vista.js"></script>
								 ...
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								    	...
								    	<td >
								   		...
								   		<td >
								     		<label style="position: relative; left: 3px; ">Asentamiento</label>
								   		</td>
								  		
								   		<td >
								     		<input class="input" id="asentamientoFormularioInput" descripcion="asentamiento" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   </tr>
								   <tr>
								   		
								   		<td >
								     		<label style="position: relative; left: 3px; ">Municipio</label>
								   		</td>
								   		<td >
								     		<input class="input" id="municipioFormularioInput" descripcion="municipio" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		<td >
								     		<label style="position: relative; left: 3px; ">Estado</label>
								   		</td>
								   		<td >
								     		<input class="input" id="estadoFormularioInput" descripcion="estado" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		<td >
								     		<label style="position: relative; left: 3px; ">Ciudad</label>
								   		</td>
								   		<td >
								     		<input class="input" id="ciudadFormularioInput" descripcion="ciudad" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   </tr>
								   		</table>	    
