...
?>
<html> 
<title>Catalogo de tramite</title>
<head>	
...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/repositorios/tramite_repositorio.js"></script>
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/tramite_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/tramite_vista.js"></script>
			...
			<div id="contieneCriteriosAriba" class="contieneCriteriosAriba">
				<div id="contieneCriteriosAribaBtn" class="contieneCriteriosAribaBtn">
					<div id="PMenu" align="center">
						...
						<div id="titulo" style="margin-left:280px;" class="tituloIEC">Catálogo de Tramite</div>
					</div>
				</div>
            </div>        
	     </div>
						...
						<div>
							<table style="position:relative;left:40px; text-align:left; margin-top:10px; margin-bottom:10px;">
								...
								<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Id</label></td>
									...
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;"> Nombre tramite</label></td>									
									<td style="padding:6px 0px 4px 10px;">		<input  id='nombreTramiteCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>
								</tr>
							</table>
						</div>
					</div>
...
<!--  barra de men� para botones de la pantalla
 -->
			<div id="menuPrincipal"  align="right" class="contieneCriteriosAribaBtn" style="background-color: #6b6b6b;    height: 56px; " > 
				...
				<span id="txtTitulo" style="float:left;margin-top: 20px;margin-left: 15px;color: #FFFFFF;float: left;font-family: Verdana;font-size: 11px;font-weight: bold;">Catálogo de tramite</span>
					 		...
					 		<div class="explicacionFRM" >
								<div id="filtros " class="contenedorIEC" style="overflow: auto; position: relative; width: 100%; display: block;">
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								    	<td >
								     		 <label style=" width:130px; position: relative; left: 3px; ">Id de tramite</label>
								   		</td>
								   		<td >
								     		<input class="input" id="idFormularioInput" type="text" maxlength="20" value="" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px;"/>
								   		</td>							   		
								   
								    	<td >
								     		<label style="position: relative; left: 3px; ">Nombre tramite</label>
								   		</td>
								   		<td >
								     		<input class="input" id="nombreTramiteFormularioInput" type="text" maxlength="140" value="" style="width:200px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px;" />
								   		</td>									   		
								    </tr>
								   </table>
									</div>
