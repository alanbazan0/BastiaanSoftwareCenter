...
<!-- 	<script language="JavaScript" type="text/JavaScript" src="js/librerias/jquery.min.js"></script> -->
    ...
    <script language="JavaScript" type="text/JavaScript" src="js/repositorios/areas_repositorio.js"></script>
    <script language="JavaScript" type="text/JavaScript" src="js/presentadores/areas_presentador.js"></script>
	<script language="JavaScript" type="text/JavaScript" src="js/vistas/areas_vista.js"></script>
			...
			<div id="contieneCriteriosAriba" class="contieneCriteriosAriba">
				<div id="contieneCriteriosAribaBtn" class="contieneCriteriosAribaBtn">
					<div id="PMenu" align="center">
						...
						<div id="titulo" style="margin-left:280px;" class="tituloIEC">Catalogo de areas</div>
					</div>
				</div>
            </div>        
	     </div>
					...
					<div id="criteriosSeleccion0_t2" style="float:left; margin-top: 6px; margin-left: 10px;">
						<div>
							<table style="position:relative;left:40px; text-align:left; margin-top:10px; margin-bottom:10px;">
								<tr>
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">ID de area</label></td>									
									<td style="padding:6px 0px 4px 10px;">		<input  id='idAreaCriterioInput' type='text' style='height: 20px; width:200px;'/></input></td>
									<td style="padding:6px 0px 4px 10px;">		<label  style="font-family: Verdana; font-size: 10px;">Nombre del area</label></td>
					 		...
					 		<div class="explicacionFRM" >
								<div id="filtros " class="contenedorIEC" style="overflow: auto; position: relative; width: 100%; display: block;">
								 <div style="width: 80%; display: block; height: 100%;  padding-top: 10px; padding-left: 34px;">								 	
								   ...
								   <tr>
								    	<td >
								     		 <label style=" width:130px; position: relative; left: 3px; ">Id de area</label>
								   		</td>
								   		<td >
								   	 ...
								   	 <tr>
								    	<td >
								     		<label style="position: relative; left: 3px; ">Nombre de area</label>
								   		</td>
								   		<td >
								     		<input class="input" id="nombreAreaFormularioInput" descripcion="Nombre Area" style=" width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px "/>
								   		</td>
								   		<td>						    
								    		<label style="position: relative; left: 3px; ">Descripcion de area</label>
								   		</td>
								   		<td>						    
								    		<input class="input" id="descripcionAreaFormularioInput" descripcion="Descripcion Area" style="width:130px; font-family:Verdana; font-size:9px;text-align:left; color:#006699;position: relative; left: 6px"/>
								   		</td>
								    </tr>
								   </table>
